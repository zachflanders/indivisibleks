// Generated on 2017-01-28 using generator-angular-fullstack 3.5.0
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    filerev: {
      dist: {
        src: [
          ...
          '<%= yeoman.dist %>/<%= yeoman.client %>/assets/images/{,*/}*.{png,jpg,jpeg,webp}'
        ]
      }
    },
    ...
    ngconstant: {
      options: {
        name: 'indivisibleks2App.constants',
